        ...
        while (true) {
            ...
            switch (opcija) {
                case (1):
                    ...
                    if (Valuta.proveriOznaku(oznaka, valute)) {
                        Valuta val = null;
                        for (int i = 0; i < valute.size(); i++) {
                        ...
                        System.out.println("-------------------");
                        System.out.println("Niste uneli vazecu valutu!!!");
                        System.out.println("-------RESET-------");
                    }
                    break;
                case (2):
                    ...
                    System.out.print("Oznaka: ");
                    String oznaka1 = sc.next();

                    if (Valuta.proveriOznaku(oznaka1, valute)) {
                        ...
                        System.out.println("-------------------");
                        System.out.println("Vas iznos je: " + Valuta.konvertujUDinare(dinar1, val) + " DIN");
                        System.out.println("-------RESET-------");
                    } else {
                        System.out.println("-------------------");
                        System.out.println("Niste uneli vazecu valutu!!!");
